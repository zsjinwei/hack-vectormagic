!(function (t) {
  ...
  class at {
    ...
    context() {
      let mctx = this.element.getContext('2d');
      if (this.element.id === 'App-ImageView-RightCanvas') {
        if (!c2sCtx) {
          c2sCtx = new C2S.Context({
            height: 2000,
            width: 0 / 0,
            ctx: mctx,
      ...
      return (
        null == this.contextCache &&
          ((this.contextCache = new ot(this, mctx)),
          1 != this.highDpiRatio &&
    ...
    function w(t, e) {
      ...
      document
        ...
        .addEventListener('click', function (event) {
          ...
          const blob = new Blob([c2sCtx.getSerializedSvg(true)], {
            type: 'image/svg+xml'
          });
